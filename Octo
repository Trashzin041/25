...
local library = {
    ...
    images = {
        ['gradientp90'] = 'https://imgur.com/w21LEoJ.png';
        ['gradientp45'] = 'https://imgur.com/w21LEoJ.png';
        ['colorhue'] = 'https://imgur.com/If4tHem.png';
        ...
        ['colortrans'] = 'https://imgur.com/w21LEoJ.png';
    };
    numberStrings = {['Zero'] = 0, ['One'] = 1, ['Two'] = 2, ['Three'] = 3, ['Four'] = 4, ['Five'] = 5, ['Six'] = 6, ['Seven'] = 7, ['Eight'] = 8, ['Nine'] = 9};
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/Quenty/NevermoreEngine/23c4c96158a582b30f13d58ebb8b9f8139aca130/src/signal/src/Shared/Signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
